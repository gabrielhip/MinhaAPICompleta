...
namespace DevIO.Business.Services
{
    public class FornecedorService : BaseService, IFornecedorService
    {
        ...
        public async Task<bool> Adicionar(Fornecedor fornecedor)
        {
            ...
            if (!ExectuarValidacao(new FornecedorValidation(), fornecedor)
                || !ExectuarValidacao(new EnderecoValidation(), fornecedor.Endereco)) return false;
        ...
        {
            if (!ExectuarValidacao(new FornecedorValidation(), fornecedor)) return false;
        ...
        {
            if (!ExectuarValidacao(new EnderecoValidation(), endereco)) return;
